sap.ui.define([
		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ap Approval Form",
									"targetURL": "#apmgtnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apmgtnspworkflowuimodule-display": {
								"semanticObject": "apmgtnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apmgtnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("apmgtnsp/workflowuimodule")
								}
							}
						}
					}
	...
	var oFlpSandbox = {
		init: function () {
			...
			// sandbox is a sinapeton, so we can start it only once
